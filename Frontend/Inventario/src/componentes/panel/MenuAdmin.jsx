    ...
    return(
      <>
          <nav className="navbar navbar-expand-lg navbar-light bg-light">
            <a className="navbar-brand" >MENU ADMINISTRADOR</a>
                  ...
                  <li className="nav-item dropdown">
                    <a className="nav-link dropdown-toggle" href="#" id="navbarDropdownMenuLink" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                      ...
                      <div className="dropdown-menu" aria-labelledby="navbarDropdownMenuLink">
                        ...
                        <Link className="dropdown-item" to={'/adminlistarasignaciones'}>Administrar Asignaciones</Link>
                      </div>
                  </li>
                  ...
                  <li className="nav-item dropdown">
                    <a className="nav-link dropdown-toggle" href="#" id="navbarDropdownMenuLink" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                      ...
                      <div className="dropdown-menu" aria-labelledby="navbarDropdownMenuLink">
                        ...
                        <Link className="dropdown-item" to={'/adminlistarusuarios'}>Administrar Usurios</Link>
                      </div>
                  </li>
